"""
Django settings for realtor_app project.
...
SECRET_KEY = 'django-insecure-kt-ka$^6eogln0prt_*%)6rm81pm-z$49n@$lezix(+9nuxp(g'
...
WSGI_APPLICATION = 'realtor_app.wsgi.application'
